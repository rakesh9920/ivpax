...
FieldPos = [zeros(1,101); zeros(1,101); (0.0028-50*1.875e-6):1.875e-6:(0.0028+50*1.875e-6)];
%FieldPos = [0; 0; 0.03];
...
VelEst = ftdoppler2(BfSigMat, FieldPos, 51);
...
FieldPos = [0;0;0.00208];

VelEst = xbeamestimate(RxSigMat, TxPos, RxPos, FieldPos, 100, 4e-6);

%%

VelEst = orthoestimate(RxSigMat, TxPos, RxPos, FieldPos, 100, 4e-6);
