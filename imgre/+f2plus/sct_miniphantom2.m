function [TargetMat] = sct_miniphantom2(targetDensity, outDir)
%SCT_MATERIALPHANTOM
...
TargetAmp(incylinder(TargetPos, [0.0045 0 0.024], 0.002)) = 2;
TargetAmp(incylinder(TargetPos, [-0.0045 0 0.016], 0.002)) = 2;
TargetAmp(incylinder(TargetPos, [0.0045 0 0.016], 0.002)) = 3;
TargetAmp(incylinder(TargetPos, [-0.0045 0 0.024], 0.002)) = 3;
...
function [Idx] = incylinder(TargetPos, Center, radius)

import tools.sqdistance

Dist = sqrt(sqdistance(Center(1, [1 3]), TargetPos(:, [1 3]))).';
