...
void f2_xdc_apodization(int, ArrayInfo *, ArrayInfo *);
...
struct ArrayInfo f2_calc_h(int, ArrayInfo *);
struct ArrayInfo f2_calc_hhp(int, int, ArrayInfo *);
struct ArrayInfo f2_calc_hp(int, ArrayInfo *);
