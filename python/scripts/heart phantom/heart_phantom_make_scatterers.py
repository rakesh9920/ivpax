...
file_path = './data/heart phantom/heart_phantom_data.h5'
key = 'field/targdata/'
img = np.mean(imread('./data/heart phantom/heart_phantom_map.bmp'), axis=2)
npixelz, npixelx = img.shape
levels = np.unique(img)
tissue = ('empty', 'myocardium', 'blood')
range_x = (-0.0463, 0.0463)
range_y = (-0.005, 0.005)
range_z = (0.001, 0.071)
