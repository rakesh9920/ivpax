...
if __name__ == '__main__':
    ...
    h1, b1, _ = ax1.hist(error_x, 100, range=(-0.015, 0.005), alpha=0.5, lw=0.7, 
        histtype='stepfilled')
    h2, b2, _ = ax1.hist(error_y, 100, range=(-0.015, 0.005), alpha=0.5, lw=0.7, 
        histtype='stepfilled')
    h3, b3, _ = ax1.hist(error_z, 100, range=(-0.015, 0.005), alpha=0.5, lw=0.7, 
        histtype='stepfilled')
    ax1.legend(('x','y','z'), loc=2, fontsize=9, frameon=False)
    ax1.set_xlim(-0.015, 0.005)
